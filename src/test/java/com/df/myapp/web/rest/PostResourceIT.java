...
import static com.df.myapp.domain.PostAsserts.*;
import static com.df.myapp.web.rest.TestUtil.createUpdateProxyForBean;
...
class PostResourceIT {
    ...
    private static final TagEnum DEFAULT_TAGS = TagEnum.NEW;
    private static final TagEnum UPDATED_TAGS = TagEnum.UPDATED;
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.updatedAt(UPDATED_UPDATED_AT).tags(UPDATED_TAGS);
